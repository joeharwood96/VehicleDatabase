...
public class ServletUnsoldVehicle extends HttpServlet {
	...
	protected void doPost(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
		...
		//Get the vehicle id of the unsold button clicked
		int vehicle_id = Integer.parseInt(req.getParameter("vehicle_id"));
		System.out.println(vehicle_id);
		//Set vehicle to sold false based on the vehicle ID
		boolean done;
		try {
			done = dao.unsoldVehicle(vehicle_id);
		if(done){
