...
<body>
	...
	<c:choose>
		...
		<c:when test="${loggedin == true}">
				<form class="form-inline" method="POST" action="./searchVehicle" style="margin-left:2%;">
				    ...
				    <a href="./API" class="btn btn-info">API Key</a>
		  		</form>
				<table class="table table-sm">
					...
					<c:forEach items="${Vehicles}" var="v">
						...
						$(document).ready(function(){
							...
							var sold = $('#unsold' + ${v.getVehicle_id()}).closest('tr').addClass('click');
							console.log("hi");
						});
						</script>
					</c:forEach>
